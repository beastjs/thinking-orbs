...
// The ThinkingOrb component for Octane. Behaviour is identical to the React
// build: one shared clock (performance.now) keeps every mounted orb in
...
//
// The geometry and painters come from `thinking-orbs/engine`, so this file
// only owns the Octane lifecycle — the pixels are the web package's pixels.
