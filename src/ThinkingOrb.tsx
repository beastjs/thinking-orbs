...
// The ThinkingOrb component for Octane. One shared clock (performance.now) keeps every mounted orb in
...
//
// The geometry and painters come from ./engine, so this file
// only owns the Octane lifecycle.
